...
class PersonaOutfitsView: UIView {
    ...
    func setupView() {
        ...
        let outfit1: UIImageView = UIImageView(frame: CGRect(x: 10, y: outfitHeightOffset, width: outfitWidth, height: self.frame.height - outfitHeightOffset - 20))
        outfit1.backgroundColor = UIColor.blueColor()
        
        let outfit2: UIImageView = UIImageView(frame: CGRect(x: 10+outfitWidth, y: outfitHeightOffset, width: outfitWidth, height: self.frame.height - outfitHeightOffset - 20))
        outfit2.backgroundColor = UIColor.blackColor()
        
        let outfit3: UIImageView = UIImageView(frame: CGRect(x: 10+outfitWidth*2, y: outfitHeightOffset, width: outfitWidth, height: self.frame.height - outfitHeightOffset - 20))
