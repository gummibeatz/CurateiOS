...
func getWeather(completionHandler:(currentTemp:Double) ->()) {
    ...
    let APPID = "96da09ef7487b3c3da75fdfa247b21fe"
    ...
    let url: NSURL = NSURL(string: "http://api.openweathermap.org/data/2.5/weather?lat=\(lat)&lon=\(lon)&units=imperial&APPID=\(APPID)")!
    print("going to \(url)")
